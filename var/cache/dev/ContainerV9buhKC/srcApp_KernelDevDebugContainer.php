...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Vx+174KRhB', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SiDO3H4N47', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'C:\\projet-symfony-RR\\src\\Entity']), 'App\\Entity');
    ...
    {
        $a = new \Symfony\Bundle\TwigBundle\Loader\NativeFilesystemLoader([], 'C:\\projet-symfony-RR');
        $a->addPath('C:\\projet-symfony-RR/templates');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\framework-bundle/Resources/views', 'Framework');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\framework-bundle/Resources/views', '!Framework');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\swiftmailer-bundle/Resources/views', '!Swiftmailer');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\twig-bundle/Resources/views', 'Twig');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\twig-bundle/Resources/views', '!Twig');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\projet-symfony-RR/templates');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\projet-symfony-RR\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy('C:\\projet-symfony-RR/public/build/manifest.json'), new \Symfony\Component\Asset\Context\RequestStackContext($c, '', false)), [])));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'C:\\projet-symfony-RR', 'UTF-8'));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rGHi4Y5h4d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('RPPDXbmE0O', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B5kVsa57oJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('70Rf78R+Gj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qiwRpWkIFF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mqd-Oub1dG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'C:\\projet-symfony-RR', function () {
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'C:\\projet-symfony-RR\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return $this->privates['var_dumper.server_connection'] = new \Symfony\Component\VarDumper\Server\Connection('tcp://'.$this->getEnv('string:VAR_DUMPER_SERVER'), ['source' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider('UTF-8', 'C:\\projet-symfony-RR', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService())), 'request' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\RequestContextProvider(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()))), 'cli' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\CliContextProvider()]);
    }
    ...
    {
        return [
            'kernel.root_dir' => 'C:\\projet-symfony-RR\\src',
            'kernel.project_dir' => 'C:\\projet-symfony-RR',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'SwiftmailerBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\swiftmailer-bundle',
                    'namespace' => 'Symfony\\Bundle\\SwiftmailerBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'WebServerBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\symfony\\web-server-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebServerBundle',
                ],
                'DoctrineFixturesBundle' => [
                    'path' => 'C:\\projet-symfony-RR\\vendor\\doctrine\\doctrine-fixtures-bundle',
            ...
            'doctrine_migrations.dir_name' => 'C:\\projet-symfony-RR/src/Migrations',
            ...
            'twig.default_path' => 'C:\\projet-symfony-RR/templates',
