...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), array(0 => 'C:\\formation-symfony\\src\\Entity')), 'App\\Entity');
...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AdRepository' => function () {
    return ($this->privates['App\Repository\AdRepository'] ?? $this->load('getAdRepositoryService.php'));
}, 'App\\Repository\\BookingRepository' => function () {
...
}, 'App\\Repository\\PasswordUpdateRepository' => function () {
    return ($this->privates['App\Repository\PasswordUpdateRepository'] ?? $this->load('getPasswordUpdateRepositoryService.php'));
